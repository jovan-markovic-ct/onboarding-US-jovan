<?php  //[STAMP] 005ee965bc6e8a460e38fb787eccc0a3
...
trait AcceptanceTesterActions
{
     ...
     * @param $newValue
     * @return array
     * @see \Helper\Acceptance::substituteArrayKey()
     */
    public function substituteArrayKey($inputArray, $keyWord, $newValue) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('substituteArrayKey', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::paymentMethodGatewayConfigExists()
     */
    public function paymentMethodGatewayConfigExists($fileData, $gateway) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('paymentMethodGatewayConfigExists', func_get_args()));
    }
     ...
     * @param $gateway
     * @return array
     * @see \Helper\Acceptance::buildPaymentMethodConfig()
     */
    public function buildPaymentMethodConfig($paymentMethod, $paymentAction, $mappedPaymentActions, $gateway) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('buildPaymentMethodConfig', func_get_args()));
    }
     ...
     * @param $path
     * @return string
     * @see \Helper\Acceptance::getFullPath()
     */
    public function getFullPath($path) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getFullPath', func_get_args()));
    }
     ...
     * @param $wordValue
     * @return string
     * @see \Helper\Acceptance::convertWordValueToBinaryString()
     */
    public function convertWordValueToBinaryString($wordValue) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('convertWordValueToBinaryString', func_get_args()));
    }
     ...
     * @see \Helper\DbHelper::getColumnFromDatabaseNoCriteria()
     */
    public function getColumnFromDatabaseNoCriteria($table, $column) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getColumnFromDatabaseNoCriteria', func_get_args()));
    }
